...
-- globals (screen, timing, state, resources) --
...
-- draw dashed center line onto the active canvas --
...
-- create or rebuild the cached center line canvas --
...
-- run game logic with fixed timestep --
...
-- run game logic with variable timestep --
